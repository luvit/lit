...
uv.tcp_connect(client, "127.0.0.1", 4821, coroutine.wrap(function (err)
  ...
  uv.write(client, encoders.wants({digest("sha1", "Hello World\n")}))
  uv.write(client, encoders.got(digest("sha1", "Hello World\n")))
  uv.write(client, encoders.nope(digest("sha1", "Hello World\n")))
  uv.write(client, encoders.query("creationix/greeting"))
  uv.write(client, encoders.reply(digest("sha1", "Hello World\n")))
end))
